...
public class EventData implements Serializable {
	private static final long serialVersionUID = 6988996762801194429L;
	...
	private static String verifyDate(String date) { //makes sure date entered can be converted to usable
		...
		int day = Integer.parseInt(finalDate.substring(6));
		if (day > Month.getDays(month) || day < 1) return null;
