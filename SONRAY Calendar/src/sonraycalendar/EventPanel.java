...
public class EventPanel extends JPanel {
	...
	public void init() {
		...
		title.grabFocus(); //initializes title and notes
		notes.grabFocus();
		grabFocus();
	}
	...
	private void initTextFields() {
		...
		title.addFocusListener(new FocusListener() { 
			...
			public void focusGained(FocusEvent e) {
				...
				if (defaultTitle.equals(title.getText()) && editMode) {
					title.setText("");
				} else title.setText(event.getTitle());
			}
			@Override
		...
		notes.addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				...
				if ("Add notes".equals(title.getText()) && editMode) {
					notes.setText("");
				} else notes.setText(event.getNotes());
			}
			@Override
			public void focusLost(FocusEvent e) {
